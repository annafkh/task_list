...
public class RecyclerViewAdapter  extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    final private String UPDATE_TASK_URL = "https://carakaautoservice.biz.id/updateTask.php";
    final private String DELETE_TASK_URL = "https://carakaautoservice.biz.id/deleteTask.php";
